<fieldset>
    <div class="row">
        <?= $form->field($model->person->personName, 'first_name')->iconPrepend('user')->label("First Name")->colSpan(6) ?>
        <?= $form->field($model->person->personName, 'last_name')->iconPrepend('user')->label("Last Name")->colSpan(6) ?>
    </div>
    <div class="row">
        <?= $form->field($model->person, 'email')->iconPrepend('envelope')->label("Email Address")->colSpan(6) ?>
