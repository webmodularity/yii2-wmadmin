...
<div class="row">
    ...
    <?= $form->field($model, 'state_id')->dropDownList(\wmc\models\AddressState::getStateList(), ['prompt' => ''])->label(false)->colSpan(['xs' => 6, 'sm' => 3]) ?>
    <?= $form->field($model, 'zip')->placeholder('Zip')->colSpan(['xs' => 6, 'sm' => 4]) ?>
</div>